...
export default function Accueil() {
    return (
        <div className="min-h-auto text-center content-center relative isolate px-6 lg:px-8">
            <div className="mx-auto bg-white brightness-100 backdrop-blur-sm rounded-3xl max-w-2xl sm:py-12 py-10 my-42 sm:my-30">
