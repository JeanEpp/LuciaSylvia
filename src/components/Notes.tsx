    ...
    return (
        <>
            <div className="flex flex-row items-center">
                ...
                <div className={`${carattere.className} text-[22px]`} style={{ visibility: "hidden" }}>{composition?.[0] ?? ""}</div>
            </div>
            <div className="flex flex-row items-center">
                <div className={`${carattere.className} text-[22px]`} style={{ visibility: "hidden" }}>{composition?.[1] ?? ""}</div>
                ...
                <div className={`${carattere.className} text-[22px] ${animate ? "animate-fade-in" : "animate-fade-out"}`}>{composition?.[1] ?? ""}</div>
            </div>
            <div className="flex flex-row items-center">
                <div className={`${carattere.className} text-[22px] ${animate ? "animate-fade-in" : "animate-fade-out"}`}>{composition?.[2] ?? ""}</div>
